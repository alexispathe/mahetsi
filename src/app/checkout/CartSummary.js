    ...
    <section className="py-8 px-4 sm:px-6 lg:px-8 bg-white shadow-lg rounded-xl mb-8 text-[#1c1f28]">
      ...
      <div className="mt-4">
        <button
          ...
          className={`w-full bg-[#009EE3] text-white py-3 px-6 rounded-md flex items-center justify-center gap-2 hover:bg-[#008ad1] transition-colors duration-200 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
            }`}
        ...
        >
          {isSubmitting ? (
            ...
            <>
              ...
              <svg className="w-6 h-6 rounded-sm" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
