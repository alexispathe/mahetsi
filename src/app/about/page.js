...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 text-gray-800">
      {/* Sección Hero */}
      <section className="relative flex items-center justify-center h-[50vh] bg-gradient-to-r from-amber-500 to-orange-500 text-white">
      ...
      <section className="py-12 px-4 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-semibold text-amber-600 mb-4">Nuestra Historia</h2>
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-semibold text-amber-600 mb-4">Misión y Visión</h2>
            <p className="mb-4 leading-relaxed">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-amber-600 mb-8">Nuestros Valores</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6 border border-amber-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-2 text-amber-600">Respeto</h3>
              <p>
            ...
            <div className="p-6 border border-amber-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-2 text-amber-600">Compromiso</h3>
              <p>
            ...
            <div className="p-6 border border-amber-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <h3 className="text-xl font-semibold mb-2 text-amber-600">Integridad</h3>
              <p>
      ...
      {/* Sección de Equipo */}
      <section className="py-12 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-amber-600 mb-8">Conoce a Nuestro Equipo</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            ...
            <p className="text-sm text-amber-600 mb-2">Fundador &amp; CEO</p>
          ...
          <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            ...
            <p className="text-sm text-amber-600 mb-2">Directora de Proyectos</p>
            <p className="text-center text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
            ...
            <p className="text-sm text-amber-600 mb-2">Diseñador Creativo</p>
            <p className="text-center text-gray-600 text-sm">
      ...
      <section className="py-12 bg-amber-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <button className="bg-white text-amber-600 font-semibold px-6 py-2 rounded-lg shadow hover:bg-gray-100 transition-colors">
            Contáctanos
          </button>
        </div>
      </section>
